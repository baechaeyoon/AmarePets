	...
	<form action="${contextPath}/miss/m_addBoard.do" enctype="multipart/form-data" method="post">
		...
		<table align="center">
			<tr>
				...
				<td width="400"><input type="text" name="miss_name" /></td>
			</tr>
			<tr>
				<td width="200"><p align="right">작성자</td>
				<td width="400"><input type="text" name="user_NAME" value="${member.user_NAME}" disabled /></td>
			</tr>
			<tr>
				<td width="200"><p align="right">작성자 이메일</td>
				<td width="400"><input type="text" name="user_Email" value="${member.user_Email}" disabled /></td>
			</tr>
			<tr>
				<td width="200"><p align="right">작성자 주소</td>
				<td width="400"><input type="text" name="user_Address" value="${member.user_Address}" disabled /></td>
			</tr>
			<tr>
				<td width="200"><p align="right">작성자 전화번호</td>
				<td width="400"><input type="text" name="user_PhoneNumber" value="${member.user_PhoneNumber}" disabled /></td>
			</tr>
			<tr>
				<td width="200"><p align="right">품종</td>
				<td width="400"><input type="text" name="miss_kind" /></td>
			</tr>
			<tr>
				<td width="200"><p align="right">성별</td>
				<td width="400">
					<input type="radio" name="miss_gender" value="수컷">수컷
					<input type="radio" name="miss_gender" value="암컷">암컷
				</td>
			</tr>
			<tr>
				<td width="200"><p align="right">나이</td>
				<td width="400"><input type="text" name="miss_age" /></td>
			</tr>
			<tr>
				<td width="200"><p align="right">실종장소</td>
				<td width="400"><input type="text" name="miss_place" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="400"><input type="text" name="miss_character" /></td>
			</tr>
			<tr>
				<td width="200"><p align="right">등록번호</td>
				<td width="400"><input type="text" name="miss_registNum" /></td>
			</tr>
			<tr>
				<td width="200"><p align="right">이미지대신</td>
				<td width="400"><input type="text" name="miss_img" /></td>
			</tr>
			<!-- <tr>
